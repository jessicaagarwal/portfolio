    ...
    <section className='contact section' id="contact">
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:agarwaljessica25@gmail.com" className="p-text">agarwaljessica25@gmail.com</a>
        </div>
        {/* <div className="app__footer-card">
          <img src={mobile} alt="phone" />
          <a href="tel: +919830200349" className="p-text">+919830200349</a>
        </div> */}
      </div>
      {!isFormSubmitted ? (
        <form className="app__footer-form app__flex" onSubmit={sendEmail}>
          ...
          <button type="submit" className="p-text">{!loading ? 'Send Message' : 'Sending...'} <svg
